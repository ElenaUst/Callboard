...
class Ad(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='создатель объявления', null=True, blank=True)
...
class Comment(models.Model):
    ...
    ad = models.ForeignKey(Ad, related_name='comment_ad', on_delete=models.CASCADE, verbose_name='объявление, под которым оставлен отзыв', null=True, blank=True)
